...
import skalaengineering.pluto.service.ProductService;
import skalaengineering.pluto.web.dto.ProductDTO;

import java.util.List;
import java.util.UUID;

import static skalaengineering.pluto.config.ApiConstants.CREATE_PRODUCT_V1_API_PATH;
import static skalaengineering.pluto.config.ApiConstants.GET_ALL_PRODUCTS_V1_API_PATH;
